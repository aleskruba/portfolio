...
const Page = () => {
  ...
  return (
      ...
      className="h-screen w-screen flex flex-col items-center justify-start bg-cover bg-center overflow-y-auto bg-gradient-to-t from-black  to-very-dark-purple"
    >
