...
const Page = () => {
  ...
  return (
    <div className="w-screen h-screen overflow-y-auto custom-scrollbar   bg-cover bg-center flex items-center justify-center pt-4 bg-gradient-to-t  from-black  to-very-dark-purple">
      <div id='contact' className="h-[50%] w-[80%] relative bg-center rounded-xl border border-white">
        <motion.div className="flex justify-start items-start  lg:pt-2 md:justify-center md:items-baseline lg:mt-8 md:ml-8 h-full" 
                    initial={{ y: "0%" }} 
                    animate={{ y: "25%" }} 
