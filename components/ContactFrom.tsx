...
return (
<div className={`flex flex-col justify-center items-baseline  md:bg-transparent px-4 mx-2 md:mx-0 text-xl md:text-2xl lg:text-3xl mb-2 text-yellow-500 font-normal ${!animationDone ? 'border border-solid border-white ' : 'gap-4'} text-gold-500 py-4 rounded-lg shadow-md`}>
