...
const ContactForm = () => {
  return (
    <div className="flex  flex-col justify-center items-baseline  md:bg-transparent px-4 mx-2 md:mx-0 text-xl md:text-2xl lg:text-3xl mb-2  text-yellow-500 font-normal border border-solid border-gold-500 text-gold-500 py-4  rounded-lg shadow-md">
